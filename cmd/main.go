...
import (
	...
	"github.com/xince-fun/balancer/pkg/controllers/balancer"
	"os"
...
func init() {
	...
	utilruntime.Must(exposerv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "59901f88.xincechen.io",
	...
	if err = (&controller.BalancerReconciler{
		...
		setupLog.Error(err, "unable to create controllers", "controllers", "Balancer")
		os.Exit(1)
	}
